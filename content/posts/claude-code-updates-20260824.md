...
2026年8月24日、Claude Code v2.1.241 がリリースされました。本バージョンは、バグ修正と信頼性改善に注力したメンテナンスリリースです。
...
v2.1.241 は、バグ修正と信頼性改善を目的としたメンテナンスリリースです。個別の変更項目の詳細は公開されていませんが、継続的な品質向上の取り組みとして提供されています。
