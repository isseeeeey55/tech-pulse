...
![](/images/newrelic-updates-20260707/header.png)
...
| カテゴリ | 対象 | 概要 | リンク |
|---------|------|------|--------|
| Other | New Relic MCP | New Relic と AI IDE Kiro 連携によるMCPプラグイン活用ガイド。AI IDEから直接New Relicの監視データやメトリクスにアクセスでき、`steering` プロファイルでAIをSRE向けの振る舞いに調整可能 | [詳細](https://qiita.com/seamoooooo/items/e458d2a7969e8c92d9ba) |
