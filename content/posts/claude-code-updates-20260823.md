...
Claude Code v2.1.240 がリリースされました。本バージョンは、バグ修正と信頼性改善を中心としたメンテナンスリリースです。

## 全変更点一覧

| カテゴリ | 内容 | 概要 |
|---------|------|------|
| Fix | Bug fixes and reliability improvements | バグ修正と信頼性の向上 |

## まとめ

v2.1.240 は、バグ修正と信頼性改善のメンテナンスリリースです。個別の変更項目は公表されていませんが、製品全体の安定性向上を目的としたアップデートとなっています。
