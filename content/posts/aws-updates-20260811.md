...
![](/images/aws-updates-20260811/header.png)
...
| AWS Elastic Disaster Recovery | [Linux サーバーの UEFI ブートモード保持に対応](https://aws.amazon.com/about-aws/whats-new/2026/08/aws-drs-linux-uefi) | これまでレガシー BIOS モードで復旧していた UEFI ブート Linux サーバーが、復旧後も UEFI モードを維持。復旧後の追加設定が不要に。ブートモード保持は自動適用で設定不要、AWS DRS 提供リージョン全てで追加コストなし |
